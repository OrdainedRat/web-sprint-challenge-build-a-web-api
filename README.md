...
They allow us to use Javascript outside of the browser, which lets use work in the backend 

1. Understand and explain the use of Middleware.

  Middleware sits exactly where it sounds, the middle. It acts as a series of process we throw our actions through for various reasons depending on our desired outcome

1. The basic principles of the REST architectural style.

It's a client-server architecture that has layers of stateless and cacheable functions

1. Understand and explain the use of Express Routers.

Express routers allow us to compartmentalize our server code, which is useful for aesthetic and production purposes
